...
CREATE TABLE VACANCIES (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY NOT NULL, STORE_ID INTEGER, SECTION_ID INTEGER, NUMBER INTEGER, ENTRY_DATE DATE)
