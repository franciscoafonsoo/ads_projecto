...
CREATE TABLE STOREMPLOYEES (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY NOT NULL, STORE_ID INTEGER, EMPLOYEE_ID INTEGER, SECTION CHAR(1))
ALTER TABLE STOREMPLOYEES ADD CONSTRAINT FK_STOREMPLOYEES_STORE_ID FOREIGN KEY (STORE_ID) REFERENCES STORE (ID)
ALTER TABLE STOREMPLOYEES ADD CONSTRAINT FK_STOREMPLOYEES_EMPLOYEE_ID FOREIGN KEY (EMPLOYEE_ID) REFERENCES EMPLOYEE (ID)