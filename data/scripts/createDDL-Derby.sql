...
CREATE TABLE EMPLOYEE (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY NOT NULL, NAME VARCHAR(255), PWD VARCHAR(255), BIRTH DATE, TLM INT, ENTRY_DATE DATE, SALARY INTEGER, VAT INTEGER, SCORE_ONE INTEGER, SCORE_TWO INTEGER, SCORE_THREE INTEGER, FILED BOOLEAN)
