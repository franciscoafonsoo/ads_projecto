...
CREATE TABLE TRANSFERS (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY NOT NULL, VACANCY_ID INTEGER, EMPLOYEE_ID INTEGER, SCORE INTEGER, ENTRY_DATE DATE, IS_PROCESSED BOOLEAN)
